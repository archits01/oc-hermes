...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingOpenComputerDesktop: '正在啟動 OpenComputer Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    appearance: {
      ...
      tipsTitle: '應用程式內提示',
      tipsDesc: '指向應用程式某處的小氣泡：閒置時偶爾出現，需要時 OpenComputer 也會給你一則。關掉一則就不再出現。',
      tipsReset: (count: number) => `復原 ${count} 則已關閉的提示`,
      toursTitle: '導覽',
      toursDesc: '讓 OpenComputer 帶你認識應用程式：調暗畫面並逐步標示每個位置。',
    ...
    gateway: {
      ...
      sshOpenComputerPathTitle: 'OpenComputer 路徑（選用）',
      sshOpenComputerPathDesc: '遠端 hermes 執行檔的完整路徑。留空 = 自動偵測。',
      sshOpenComputerPathPlaceholder: '自動偵測',
    ...
    toolsets: {
      ...
      useBackend: '使用此後端',
      nousIncluded: '包含在 Nous 訂閱中；登入 Portal 即可啟用。',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: '教一次就夠',
        text: '技能是一組說明檔，OpenComputer 會在需要時自行載入。'
      },
      messaging: {
        title: '離開電腦也能用',
      ...
      profiles: {
        title: '設定檔彼此獨立',
        text: '每個都是獨立的 OpenComputer — 自己的金鑰、記憶與工作階段。'
      },
      'composer-mentions': {
        title: '附件與指令',
